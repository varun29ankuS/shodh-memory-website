...
const RESEARCH_CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    description: "Content-addressable recall and energy-based memory retrieval\u2014the foundation that transformers rediscovered",
    blogSlug: "knowledge-graph-spreading-activation",
    blogLabel: "From Hopfield to Modern Memory",
    ascii: [
      "  Energy landscape:",
      "",
      "  \u2572      \u2571\u2572      \u2571\u2572      \u2571",
    ...
    papers: [
      {
        ...
        journal: "Proceedings of the National Academy of Sciences, 79(8), 2554-2558",
        doi: "10.1073/pnas.79.8.2554",
        usage: "The foundational paper on content-addressable memory. Shodh's core retrieval\u2014query by similarity, converge to nearest stored memory\u2014is a Hopfield recall operation over a knowledge graph.",
        bibtexKey: "hopfield1982neural",
      },
      {
        ...
        usage: "Proved transformer attention is mathematically equivalent to a modern Hopfield network update rule. Shodh's softmax-weighted retrieval scoring over stored memories operates on the same principle\u2014energy minimization over an associative store.",
        bibtexKey: "ramsauer2021hopfield",
      },
      {
        authors: "Krotov, D. & Hopfield, J.J.",
        year: 2016,
        title: "Dense Associative Memories for Pattern Recognition",
        journal: "Advances in Neural Information Processing Systems (NeurIPS), 29",
        doi: "10.48550/arXiv.1606.01164",
        usage: "Modern Hopfield networks with exponential storage capacity. Validates that associative memory scales\u2014shodh's knowledge graph is an associative network with Hebbian-strengthened edges.",
        bibtexKey: "krotov2016dense",
      },
    ],
  },
  {
    title: "Biologically Plausible Learning",
    description: "Local learning rules that don't need backpropagation\u2014how brains actually learn",
    blogSlug: "hebbian-learning-ai-agents",
    blogLabel: "Learning Without Backpropagation",
    ascii: [
    ...
    papers: [
      {
        ...
        usage: "Hinton's alternative to backpropagation using local learning without backward passes. Shodh's Hebbian edge updates follow the same philosophy\u2014purely local rules, no global error signal, biologically plausible weight adjustment.",
        bibtexKey: "hinton2022forwardforward",
      },
      {
        authors: "Magee, J.C. & Grienberger, C.",
        year: 2020,
        title: "Synaptic Plasticity Forms and Functions",
        journal: "Annual Review of Neuroscience, 43, 95-117",
        doi: "10.1146/annurev-neuro-090919-022842",
        usage: "Comprehensive review of synaptic plasticity mechanisms including LTP phases. Directly implemented in shodh's 3-tier edge system: L1 Working (early-LTP, minutes), L2 Episodic (late-LTP, hours\u2013days), L3 Semantic (structural LTP, permanent).",
        bibtexKey: "magee2020plasticity",
      },
      {
        authors: "Markram, H. et al.",
        year: 2012,
        title: "A History of Spike-Timing-Dependent Plasticity",
        journal: "Frontiers in Synaptic Neuroscience, 3, 4",
        doi: "10.3389/fnsyn.2011.00004",
        usage: "Documents the transition from rate-based to timing-based Hebbian learning. Shodh's co-retrieval strengthening (accessing memories in the same session strengthens their edge) implements the rate-based variant of STDP.",
        bibtexKey: "markram2012stdp",
      },
    ],
  },
  {
    title: "Vector Search & Approximate Nearest Neighbors",
    description: "Efficient similarity search at scale without brute force",
    blogSlug: "why-not-just-vector-search",
    blogLabel: "How Shodh Searches Billions",
    ascii: [
    ...
    papers: [
      {
        authors: "Subramanya, S.J. et al.",
        year: 2019,
        title: "DiskANN: Fast Accurate Billion-point Nearest Neighbor Search on a Single Node",
        journal: "Advances in Neural Information Processing Systems (NeurIPS), 32",
        doi: "10.48550/arXiv.1903.09556",
        usage: "The paper behind shodh's primary vector index. Our Vamana implementation uses DiskANN's greedy search with robust pruning for graph construction, enabling sub-millisecond ANN search on disk-resident data.",
        bibtexKey: "subramanya2019diskann",
      },
      {
        ...
        usage: "Shodh auto-switches from Vamana to SPANN when memory count exceeds 100k. SPANN's inverted index with product quantization enables billion-scale search with bounded memory via disk-based posting lists.",
        bibtexKey: "chen2021spann",
      },
      {
        authors: "Jegou, H. et al.",
        year: 2011,
        title: "Product Quantization for Nearest Neighbor Search",
        journal: "IEEE Transactions on Pattern Analysis and Machine Intelligence, 33(1), 117-128",
        doi: "10.1109/TPAMI.2010.57",
        usage: "Foundation of the PQ compression in shodh's SPANN tier. 384-dim MiniLM vectors are decomposed into subspaces and quantized to codebook indices, reducing memory footprint by ~32x.",
        bibtexKey: "jegou2011pq",
      },
    ],
  },
];
...
const SHODH_APA = `Sharma, V. (2026). shodh-memory: Cognitive memory for AI agents (Version 0.1.90) [Computer software]. https://doi.org/10.5281/zenodo.18668709`;
