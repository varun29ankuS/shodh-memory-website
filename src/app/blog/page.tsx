...
export const BLOG_POSTS = [
  {
    ...
    date: "2026-04-03",
    readTime: "14 min",
    tags: ["mcp", "tutorial", "agentic-ai"],
    excerpt: "Your AI agent resets every session. MCP changes that. The complete guide to setting up shodh-memory's MCP server — what MCP is, how to configure it for Claude, Cursor, and any client, all 45 tools explained, and automatic memory via hooks.",
  },
  {
    slug: "best-ai-agent-frameworks-2026",
    title: "Best AI Agent Frameworks 2026: LangChain, CrewAI, AutoGen, OpenAI Agents SDK Compared",
    date: "2026-04-03",
    readTime: "13 min",
    tags: ["agentic-ai", "comparison", "architecture"],
    excerpt: "Every framework solves orchestration. None of them solve memory. A head-to-head comparison of LangChain, CrewAI, AutoGen, and OpenAI Agents SDK — what each does well, where each falls short, and why memory is the missing layer.",
  },
  {
    slug: "graph-databases-for-ai-memory",
    title: "Graph Databases for AI Memory: Why Your Agent Needs a Knowledge Graph",
    date: "2026-04-03",
    readTime: "14 min",
    tags: ["architecture", "cognition", "agentic-ai"],
    excerpt: "Vector search finds similar things. Graphs find connected things. Your agent needs both. How graph databases enable causal reasoning, spreading activation, and entity disambiguation in AI memory systems.",
  },
  {
    slug: "cognitive-architectures-for-ai-agents-guide",
    title: "Cognitive Architectures for AI Agents: From ACT-R to Modern Memory Systems",
    date: "2026-04-03",
    readTime: "15 min",
    tags: ["cognition", "neuroscience", "architecture"],
    excerpt: "GPT-4 has no architecture. It has a context window. From SOAR and ACT-R to Cowan's embedded processes model — how cognitive science maps to AI agent memory, and why the 'limited memory AI' problem persists.",
  },
  {
    slug: "vector-databases-how-they-work",
    title: "Vector Databases Explained: How Semantic Search Powers AI Memory",
    date: "2026-04-03",
    readTime: "12 min",
    tags: ["architecture", "tutorial", "comparison"],
    excerpt: "Ctrl+F finds exact matches. Vector search finds meaning. How embeddings, cosine similarity, and indexing algorithms work — from brute force to Vamana to SPANN — and why vector search alone is not memory.",
  },
  {
    slug: "ai-model-pricing-guide-2026",
    title: "AI Model Pricing Guide 2026: Claude, GPT-4.1, Grok, Gemini, DeepSeek Compared",
    date: "2026-04-03",
    readTime: "15 min",
    tags: ["comparison", "trends", "agentic-ai"],
    excerpt: "Every AI model's API pricing in one place — Claude, GPT-4.1, Gemini 2.5, Grok 3, DeepSeek V3. Input/output costs, context windows, subscription tiers, and the hidden cost nobody talks about: re-explaining context every session.",
  },
  {
    slug: "types-of-memory-in-ai",
    title: "Types of Memory in AI: From Working Memory to Long-Term Potentiation",
    date: "2026-04-03",
    readTime: "13 min",
    tags: ["cognition", "neuroscience", "architecture"],
    excerpt: "The definitive guide to memory types — sensory, working, long-term, episodic, semantic, procedural. How each maps from neuroscience to AI systems, with ASCII diagrams of the full memory hierarchy.",
  },
  {
    slug: "chatgpt-memory-full-unlimited-alternative",
    title: "ChatGPT Memory Is Full? Here's Unlimited AI Memory That Never Fills Up",
    date: "2026-04-03",
    readTime: "12 min",
    tags: ["comparison", "agentic-ai", "privacy"],
    excerpt: "ChatGPT memory fills up in a day and forces you to manually delete facts. Here's an open-source alternative with no storage cap — cognitive memory that strengthens with use, decays naturally, and runs 100% offline.",
  },
  {
    slug: "openai-assistants-api-deprecated-alternative",
    title: "OpenAI Killed the Assistants API. Here's How to Own Your Memory Layer",
    date: "2026-04-03",
    readTime: "14 min",
    tags: ["agentic-ai", "architecture", "migration"],
    excerpt: "The Assistants API shuts down August 2026. Threads, runs, conversation state — all gone. Here's how to migrate to a standalone memory layer you own, with step-by-step code for the Responses API + shodh-memory.",
  },
  {
